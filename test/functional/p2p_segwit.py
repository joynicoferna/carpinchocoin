...
class SegWitTest(CARPINCHOTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older carpinchod's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let carpinchod fill it in.
