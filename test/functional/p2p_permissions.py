...
class P2PPermissionsTests(CARPINCHOTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].carpinchoconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].carpinchoconf, 'w', encoding="utf8") as f:
            f.write(newText)
