...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CARPINCHOTestFramework
    pass


class ExampleTest(CARPINCHOTestFramework):
    # Each functional test is a subclass of the CARPINCHOTestFramework class.
    ...
    def custom_method(self):
        ...
        CARPINCHOTestFramework class so other tests can use it."""
