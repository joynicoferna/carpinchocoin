...
"""Verify that starting carpincho with -h works as expected."""

from test_framework.test_framework import CARPINCHOTestFramework
from test_framework.util import assert_equal

class HelpTest(CARPINCHOTestFramework):
    ...
    def run_test(self):
        self.log.info("Start carpincho with -h for help text")
        ...
        self.log.info("Start carpincho with -version for version information")
        ...
        self.log.info("Start carpinchod with -fakearg to make sure it does not start")
