...
class TestShell:
    """Wrapper Class for CARPINCHOTestFramework.

    The TestShell class extends the CARPINCHOTestFramework
    ...
    class __TestShell(CARPINCHOTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CARPINCHOTestFramework child class.
            self.num_nodes = 1
