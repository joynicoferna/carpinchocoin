...
By default, carpinchod will dump mempool on shutdown and
...
class MempoolPersistTest(CARPINCHOTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent carpinchod from writing mempool.dat to disk. Verify that `savemempool` fails")
