...
// carpincho includes.
#include <..\src\script\carpinchoconsensus.h>
...
int main()
{
    std::cout << "carpinchoconsensus version: " << carpinchoconsensus_version() << std::endl;
    ...
    auto op0Result = carpinchoconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, carpinchoconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
