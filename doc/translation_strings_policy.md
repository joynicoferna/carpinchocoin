...
This document provides guidelines for internationalization of the CARPINCHO Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `carpincho_en.ts` remains unchanged.
