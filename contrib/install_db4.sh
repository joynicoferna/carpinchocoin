...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the carpincho repository."
  exit 1
fi
...
# See https://github.com/carpincho/carpincho/issues/16064
...
echo 'When compiling carpinchod, run `./configure` in the following way:'
echo
