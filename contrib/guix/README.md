# Bootstrappable CARPINCHO Core Builds

This directory contains the files necessary to perform bootstrappable CARPINCHO
Core builds.
...
- 24GB of free disk space on the partition that the CARPINCHO Core git repository
  resides in
...
For a CARPINCHO Core depends development environment, simply invoke
...
From the top of a clean CARPINCHO Core repository:
...
To use dongcarl's substitute server for CARPINCHO Core builds after having
