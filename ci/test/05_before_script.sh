...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/CARPINCHO
else
  DOCKER_EXEC echo \> \$HOME/.carpincho
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/carpincho/carpincho/pull/18288#discussion_r433189350 for
  # details.
