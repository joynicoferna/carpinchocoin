...
#ifndef CARPINCHO_TEST_SCRIPTNUM10_H
#define CARPINCHO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CARPINCHO Core 0.10.0, for cross-comparison.
 */
public:
