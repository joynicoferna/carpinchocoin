...
{
    BOOST_CHECK(TestSplitHost("www.carpinchocore.org", "www.carpinchocore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.carpinchocore.org]", "www.carpinchocore.org", -1));
    BOOST_CHECK(TestSplitHost("www.carpinchocore.org:80", "www.carpinchocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.carpinchocore.org]:80", "www.carpinchocore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:42006", "127.0.0.1", 42006));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:42006", "127.0.0.1", 42006));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:42006", "::ffff:127.0.0.1", 42006));
    BOOST_CHECK(TestSplitHost("[::]:42006", "::", 42006));
    BOOST_CHECK(TestSplitHost("::42006", "::42006", -1));
    BOOST_CHECK(TestSplitHost(":42006", "", 42006));
    BOOST_CHECK(TestSplitHost("[]:42006", "", 42006));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:42006", "127.0.0.1:42006"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:42006", "[::]:42006"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
