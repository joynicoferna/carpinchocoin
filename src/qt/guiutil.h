...
#ifndef CARPINCHO_QT_GUIUTIL_H
#define CARPINCHO_QT_GUIUTIL_H
...
/** Utility functions used by the CARPINCHO Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "carpincho:" URI into recipient object, return true on successful parsing
