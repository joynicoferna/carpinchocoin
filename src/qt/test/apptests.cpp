...
//! Entry point for CARPINCHOApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CARPINCHOApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CARPINCHOGUI tests.
void AppTests::guiTests(CARPINCHOGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CARPINCHOGUI::consoleShown, this, &AppTests::consoleTests);
