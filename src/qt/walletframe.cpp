...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, CARPINCHOGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &CARPINCHOGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &CARPINCHOGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &CARPINCHOGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &CARPINCHOGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &CARPINCHOGUI::updateWalletStatus);
    connect(gui, &CARPINCHOGUI::setPrivacy, walletView, &WalletView::setPrivacy);
