    ...
    platformStyle(_platformStyle)
{
    ...
    // normal carpincho address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying carpincho address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CARPINCHOAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
