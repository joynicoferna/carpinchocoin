    ...
    mapper(nullptr)
{
    ...
    ui->carpinchoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->carpinchoAtStartup);
    ...
    ui->carpinchoAtStartup->setToolTip(ui->carpinchoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->carpinchoAtStartup->setText(ui->carpinchoAtStartup->text().arg(PACKAGE_NAME));

    ui->openCARPINCHOConfButton->setToolTip(ui->openCARPINCHOConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CARPINCHOUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->carpinchoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCARPINCHOConfButton_clicked()
{
