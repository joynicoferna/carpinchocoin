...
#ifndef CARPINCHO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CARPINCHO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CARPINCHO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
