...
#ifndef CARPINCHO_COMPAT_ASSUMPTIONS_H
#define CARPINCHO_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "CARPINCHO cannot be compiled without assertions."
#endif
...
#endif // CARPINCHO_COMPAT_ASSUMPTIONS_H
