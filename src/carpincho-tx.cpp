...
static void SetupCARPINCHOTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " carpincho-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  carpincho-tx [options] <hex-tx> [commands]  Update hex-encoded carpincho transaction\n" +
            "or:     carpincho-tx [options] -create [commands]   Create hex-encoded carpincho transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded carpincho transaction
