 ...
 */
#ifndef CARPINCHO_UTIL_SYSTEM_H
#define CARPINCHO_UTIL_SYSTEM_H
...
extern const char * const CARPINCHO_CONF_FILENAME;
extern const char * const CARPINCHO_SETTINGS_FILENAME;
