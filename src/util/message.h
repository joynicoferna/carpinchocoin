...
#ifndef CARPINCHO_UTIL_MESSAGE_H
#define CARPINCHO_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's carpincho address, it must refer to a public key.
...
#endif // CARPINCHO_UTIL_MESSAGE_H
