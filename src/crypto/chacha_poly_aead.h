...
#ifndef CARPINCHO_CRYPTO_CHACHA_POLY_AEAD_H
#define CARPINCHO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@carpincho.
 *
 ...
 *
 * The chacha20-poly1305@carpincho combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@carpincho cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@carpincho are relatively fast in
...
#endif // CARPINCHO_CRYPTO_CHACHA_POLY_AEAD_H
