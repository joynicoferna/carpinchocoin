...
#ifndef CARPINCHO_WALLET_WALLET_H
#define CARPINCHO_WALLET_WALLET_H
...
public:
     ...
     * on this carpincho node, and set to 0 for transactions that were created
...
#endif // CARPINCHO_WALLET_WALLET_H
