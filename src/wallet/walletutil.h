...
#ifndef CARPINCHO_WALLET_WALLETUTIL_H
#define CARPINCHO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! carpincho from opening the wallet, thinking it was newly created, and
...
#endif // CARPINCHO_WALLET_WALLETUTIL_H
