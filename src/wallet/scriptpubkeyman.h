...
#ifndef CARPINCHO_WALLET_SCRIPTPUBKEYMAN_H
#define CARPINCHO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The CARPINCHO Core wallet was originally a collection of unrelated private
...
#endif // CARPINCHO_WALLET_SCRIPTPUBKEYMAN_H
